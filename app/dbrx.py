...
def get_dbrx_client():
    """Get DBRX client for AI analysis."""
    try:
        # Try to get actual Databricks client first
        client = WorkspaceClient()
        return client
    except Exception as e:
        logger.info(f"Failed to create Databricks client: {e}")
        # Return None to indicate no client available
        return None
